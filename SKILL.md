...
## ⚡ 说明
无极军团的默认入口是 MoE 参谋本部，不是完整军团全量启动器。全局铁律与MoE参谋本部已在 `.codex/AGENTS.md` 中永久生效；此处保存完整技能体系（14个部门+69位专家），仅在命中路由或彻查任务时按需读取。
...
- “阿极/启动无极军团”代表启动 MoE 参谋本部门控，不代表加载完整体系
