# 第三师（ComfyUI） - ComfyUI主帅 + 节点/工作流模式

## 核心定位

第三师只有一个入口：`ComfyUI主帅`。

普通生图不进第三师，直接走 `imagegen`。只有当任务涉及 ComfyUI 工作流、节点插件、批量生成、视频管线或技术美术时，第三师才接管。
...
| 模式 | 适用任务 | 验证 |
|---|---|---|
| 工作流模式 | 搭建/修改 ComfyUI 工作流 | 参数可复跑、种子和模型记录 |
...
- `ComfyUI主帅`：唯一 ComfyUI 入口，内部包含工作流、插件、视频动效和技术美术模式。
