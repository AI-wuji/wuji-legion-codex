...
- 逐字稿不是 PPT 页稿，必须先删、并、改、提炼，形成能演示的页纲
- 每页必须有一个结论句，而不是一个话题名或一段原文
- 模板页只能按功能选用：封面、目录、章节、问题、方法、案例、练习、总结、行动，不按原模板顺序填文字
- 模板风格要继承，内容结构要重建；看起来像“把 Word 贴进模板”即退回重做
- 臧老师验收重点：信息层级、留白、节奏、视觉证明物、每页核心信息是否清晰
